...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.dish-card, .stat-item, .category-card').forEach(el => observer.observe(el));
    ...
    const animateFormSuccess = () => {
        reservationForm.innerHTML = '<div class="success-message">Thank you! Your reservation has been received.</div>';
        document.querySelector('.success-message').style.animation = 'fadeInUp 0.5s ease';
    };
